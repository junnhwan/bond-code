...
var builtinSurfaceDescriptors = []SurfaceDescriptor{
	...
	// Compatibility-only: still runnable when typed, hidden from default / discovery.
	{ID: "command.model", Name: "model", Visibility: SurfaceCompatibilityOnly, Shortcut: "/model", Description: "Switch the active model without restarting (/model <name>; no arg shows current)", ExecutionTarget: "registry.model"},
	{ID: "command.permissions", Name: "permissions", Visibility: SurfaceCompatibilityOnly, Shortcut: "/permissions", Description: "Show permission mode", ExecutionTarget: "registry.permissions"},
	{ID: "command.diff", Name: "diff", Visibility: SurfaceCompatibilityOnly, Shortcut: "/diff", Description: "Review session file changes (diff viewer)", ExecutionTarget: "overlay.diff"},
	{ID: "command.history", Name: "history", Visibility: SurfaceCompatibilityOnly, Shortcut: "/history", Description: "Browse session timeline (fork-resume)", ExecutionTarget: "overlay.history"},
